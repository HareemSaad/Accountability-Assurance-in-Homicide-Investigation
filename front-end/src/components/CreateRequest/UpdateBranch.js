            ...
            <form>
                ...
                <div className="row g-3 align-items-center m-3">
                    ...
                    <div className="col-9 input">
                        <input type="text" name='precinctAddress' id="precinctAddress" placeholder='Enter Precinct Address Here' className="form-control" onChange={handleChange}></input>
                    </div>
                </div>
                ...
                <div className="row g-3 align-items-center m-3">
                    ...
                    <div className="col-9 input">
                        <input type="text" name='jurisdictionArea' id="jurisdictionArea" placeholder='Enter Jurisdiction Area Here' className="form-control" onChange={handleChange}></input>
                    </div>
                </div>
                ...
                <div className="row g-3 align-items-center m-3">
                    ...
                    <div className="col-9 input">
                        <input type="number" name='stateCode' id="stateCode" placeholder='Enter State Code Here' className="form-control" onChange={handleChange}></input>
                    </div>
                </div>
